...
public class Rating {
	...
	public String AddRating(String productId, String ratingValue, String review, String overallRating){ // Adding ratings
		...
		try {
			 ...
			 con.close();
			 output = "Rating Inserted successfully!!";
	   }
	   catch (Exception e){
			 output = "Error while inserting the Rating!!";
	...
	public String UpdateRatings(String ratingId, String ratingValue, String review, String overallRating){
	 ...
	 try {
		 ...
		 preparedStmt.execute();
		 con.close();
		 output = "Rating values Updated successfully";
	 }
	 catch (Exception e){
		 output = "Error while updating the Rating values.";
		 System.err.println(e.getMessage());
	 }
	...
	public String DeleteRating(String ratingId){
		 ...
		 try {
			 ...
			 preparedStmt.execute();
			 con.close();
			 output = "Rating element Deleted successfully";
		 }
		 catch (Exception e){
			 output = "Error while deleting the Rating element.";
			 System.err.println(e.getMessage());
		 }
